<div>
    @if($energyStatus)
        <div class="flex items-center gap-2 mb-2">
            ...
            <h3 class="font-medium text-gray-900 dark:text-zinc-50">Energía</h3>
            <span class="ml-auto text-xs text-gray-500 dark:text-zinc-400 font-mono">{{ round($energyStatus['current']) }}/{{ $energyStatus['max'] }}</span>
        </div>
        <div class="w-full bg-gray-100 dark:bg-zinc-700 rounded h-2 overflow-hidden">
            <div 
